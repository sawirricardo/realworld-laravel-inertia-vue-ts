...
')
     ...
     */ 
         ...
         * @static 
         */ 
        public static function create($start, $end, $interval, $format = 'H:i', $excludes = [])
        {
                        /** @var \Label84\HoursHelper\HoursHelper $instance */
                        return $instance->create($start, $end, $interval, $format, $excludes);
        }
...
namespace  { 
            ...
            class HoursHelper extends \Label84\HoursHelper\Facades\HoursHelper {}
